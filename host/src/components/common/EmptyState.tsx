...
import { EmptyIllustration, type EmptyKind } from './EmptyIllustration';

interface EmptyStateProps {
  icon: keyof typeof Ionicons.glyphMap;
  /** Optional spot illustration shown instead of the icon halo. */
  illustration?: EmptyKind;
  title: string;
  message?: string;
    ...
    <View style={[styles.container, style]}>
      {illustration ? (
        <View style={styles.illoWrap}>
          <EmptyIllustration kind={illustration} size={156} />
        </View>
      ) : (
