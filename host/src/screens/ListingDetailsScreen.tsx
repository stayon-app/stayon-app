  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScreenHeader
        ...
        rightActions={[
          { icon: 'create-outline', onPress: () => navigation.navigate('ListingEdit', { id: listing.id }), accessibilityLabel: 'Edit listing' },
          { icon: 'trash-outline', onPress: remove, tint: colors.error, accessibilityLabel: 'Delete listing' },
        ]}
      />
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: spacing['4xl'] }}>
        ...
        <View style={styles.body}>
          ...
          {/* Manage shortcuts */}
          <Text style={styles.section}>Manage this listing</Text>
          <TouchableOpacity style={styles.manageRow} activeOpacity={0.85} onPress={() => { light(); navigation.navigate('ListingEdit', { id: listing.id }); }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.manageTitle}>Edit listing details</Text>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={{ flex: 1 }} activeOpacity={0.9} onPress={() => { light(); navigation.navigate('ListingEdit', { id: listing.id }); }}>
          <LinearGradient colors={STAYON_GRADIENT} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.editBtn}>
            ...
            <Text style={styles.editText}>Edit listing details</Text>
          </LinearGradient>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
