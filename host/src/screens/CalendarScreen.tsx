  ...
  if (listings.length === 0) {
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <EmptyState illustration="calendar" icon="calendar-outline" title="Publish a listing first" message="When you publish a listing you’ll be able to see and edit your calendar here." actionLabel="Create a listing" onAction={() => navigation.navigate('ListingCreate')} />
      </SafeAreaView>
    );
  }
            ...
            {cells.map((c, i) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => openEdit(c.ds, disabled)}
                >
