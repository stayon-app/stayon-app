...
// drive every conversion to the guest's currency. Fetched from a free, keyless
// endpoint, cached to AsyncStorage, and fall back to the static sample rates in
// utils/currency.ts when the network is unavailable.
