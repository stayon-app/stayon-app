...
const TIPS = [
  { icon: 'sunny-outline', title: 'Bright daytime photos', body: 'Stays with 12+ light, tidy photos get the most clicks. Lead with your best room.' },
  { icon: 'flash-outline', title: 'Turn on Instant Book', body: 'Instant‑book stays appear in more searches and convert faster.' },
    ...
    React.useCallback(() => {
      ...
      (async () => {
        ...
        setSteps([
          ...
          { key: 'listing', title: 'Publish a stay', sub: 'Your place needs to be live to get booked', done: !!published, route: published ? 'ListingDetails' : 'ListingCreate', params: published ? { id: published.id } : undefined },
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: spacing.lg, paddingBottom: spacing['4xl'] }}>
        ...
        <View style={styles.promoCard}>
          <View style={styles.promoTop}>
            ...
            <Text style={styles.promoTitle}>New‑stay promotion</Text>
          </View>
          <Text style={styles.promoBody}>Offer 20% off to your first 3 guests. It’s the fastest way to earn those crucial first reviews that push your stay up the search results.</Text>
          <TouchableOpacity style={styles.promoBtn} activeOpacity={0.9} onPress={() => { light(); navigation.navigate('Listings'); }}>
            <Text style={styles.promoBtnText}>Set up in your stay</Text>
