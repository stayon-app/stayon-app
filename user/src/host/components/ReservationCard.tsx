      ...
      <View style={styles.top}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.codeChip}>
            ...
            <Text style={styles.code}>Confirmation {r.code}</Text>
          </View>
        </View>
      </View>
...
const makeStyles = (colors: any) =>
  StyleSheet.create({
    ...
    codeChip: { flexDirection: 'row', alignItems: 'center', gap: 4, alignSelf: 'flex-start', marginTop: 5, paddingHorizontal: spacing.sm, paddingVertical: 3, borderRadius: 999, backgroundColor: colors.primarySubtle },
    code: { fontSize: fontSizes.xs, color: colors.primary, letterSpacing: 0.3, ...fonts.bold },
